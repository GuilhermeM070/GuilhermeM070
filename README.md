...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/NoSQL-green?style=for-the-badge" alt="NoSQL"/>
</p>
...
- **Java**: Powerful, cross-platform, and perfect for building large-scale systems.
- **Python**: Simple and versatile, ideal for Machine Learning, Data Science, and web development.
- **JavaScript**: The go-to language for front-end web development, and expanding into backend with Node.js.
- **Spring Boot**: Makes it easy to create stand-alone, production-grade Spring-based applications.
- **Angular**: A robust framework for dynamic and single-page web apps.
- **MySQL & MongoDB**: Reliable and scalable databases for storing and querying data effectively.
- **Git**: Version control that powers collaboration and team workflows in software development.
- **VS Code**: A powerful and lightweight code editor that supports a multitude of languages and tools.

---

### 💡 **Continuous Growth & Innovation** 🌱
Always learning, experimenting, and striving for excellence. Let's innovate together! 🌍
